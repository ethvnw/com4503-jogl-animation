...
public class Mat4 {   // row column formulation
  ...
  /**
   * Get the column of the matrix at the given index.
   * @author Ethan Watts (eawatts1@sheffield.ac.uk)
   * @param i The index of the column to get
   * @return The column of the matrix at the given index
   */
  public float[] getColumn(int i) {
    return new float[]{values[0][i], values[1][i], values[2][i], values[3][i]};
  }

  /**
   * Get the value at the given row and column of the matrix.
   * @author Ethan Watts (eawatts1@sheffield.ac.uk)
   * @param r The row
   * @param c The column
