...
/**
 * Mesh class to handle a mesh object in the scene.
...
public class Mesh {
  ...
  /**
   * Create a mesh object with the given parameters.
  ...
  /**
   * Fill the buffers with the mesh object.
   * @param gl The GL3 object
   */
